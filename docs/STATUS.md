...
- C10: C10-01, C10-02, C10-03, C10-03.1 y C10-04 integrados en `main`; CI verde. C10-04 corrige foco modal, objetivos táctiles, safe-area/stacking y reduce motion permanente. Alcance en [`C10-04-ALCANCE.md`](C10-04-ALCANCE.md) y evidencia en [`QA-C10-04.md`](QA-C10-04.md).
