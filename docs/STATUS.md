...
- C10: planificación iterativa UX creada; C10-01, C10-02 y C10-03 aprobados. La revisión externa agregó C10-03.1 para corregir la semántica del origen y distinguir intenciones web pendientes de WhatsApp antes de C10-04; alcance en [`C10-03.1-ALCANCE.md`](C10-03.1-ALCANCE.md).
